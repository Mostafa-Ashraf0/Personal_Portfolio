...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    projects_images: Schema.Attribute.Relation<
      'oneToMany',
      'api::projects-image.projects-image'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectsImageProjectsImage
  extends Struct.CollectionTypeSchema {
  collectionName: 'projects_images';
  info: {
    displayName: 'projects_images';
    pluralName: 'projects-images';
    singularName: 'projects-image';
  };
  options: {
    draftAndPublish: true;
  };
